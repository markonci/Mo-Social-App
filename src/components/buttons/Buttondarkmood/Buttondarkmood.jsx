...
import style from './Buttondarkmood.module.css'
import styled from 'styled-components';
import { ChangemoodContext } from '../../../Context/ChangemoodContext';

export default function Buttondarkmood() {

  let {changemood}= useContext(ChangemoodContext)
  
  return (
    <>
    <StyledWrapper className='me-9 md:me4 mt-1 max-md:order-2 '>
      <label  className="theme-switch ">
        <input  onClick={changemood} type="checkbox" className="theme-switch__checkbox" />
...
const StyledWrapper = styled.div`
  ...
  .theme-switch__sun-moon-container {
    ...
    margin: auto;
    border-radius: var(--container-radius);
    background-color: var(--moon-bg); /* افتراضي: قمر */
  ...
  /* القمر يختفي عند التفعيل */
  .theme-switch__checkbox:checked + .theme-switch__container .theme-switch__moon {
    transform: translateX(100%);
  }

  /* السحاب يظهر عند التفعيل */
  .theme-switch__checkbox:checked + .theme-switch__container .theme-switch__clouds {
    bottom: -0.625em;
  }

  /* النجوم تختفي عند التفعيل */
  .theme-switch__checkbox:checked + .theme-switch__container .theme-switch__stars-container {
    top: -100%;
    transform: none;
  }

  /* الشمس تظهر عند التفعيل */

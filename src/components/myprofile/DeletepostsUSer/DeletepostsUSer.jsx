...
export default function DeletepostsUSer({ id }) {
  ...
  function deletePosts() {
    setisLoding(true)
    axios.delete(`${APi_BASEURL}/posts/${id}`, {
      headers: {
          ...
          >
            <div className="bg-gray-800">
              ...
              <div className="p-2 mt-2 text-center space-x-1 md:block">
                ...
                >
                      {isLoding?<GrPowerCycle className="animate-spin mx-auto text"/>:'Confirm Delete?'}                </button>
              </div>
            </div>
          </motion.div>
        </>

...
export default function Deletecomment({ id }) {
  ...
  return (
    <>
      ...
      <button
        onClick={handleShow}
        className="align-middle mt-3 pt-2 text-2xl cursor-pointer me-3 dark:text-white text-black dark:hover:text-black hover:text-red-600 transition duration-[0.3s]"
      >
